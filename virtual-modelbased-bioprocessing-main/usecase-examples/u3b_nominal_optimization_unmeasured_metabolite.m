...
supplementary_file = '../models/K-Net/supplementary_ext.xls';
...
index_data.growth_index = 8; % growth rate index is the rate of biomass
index_data.involved_met_indices = [1:8];
...
constraints.rate_bounds([1:5,7:8],:) = define_rates_bounds_percentage_on_data(qext_data,0.5);
...
initial_conditions_data.qext([1:5,7:8],:) = qext_data(:,1:end);
initial_conditions_data.qext(6,:) = rand(1,size(initial_conditions_data.cext,2))*50;
